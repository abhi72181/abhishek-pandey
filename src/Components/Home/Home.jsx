  ...
  return (
    <div ref={scrollRef}>
      ...
      >
        ...
        >
          ...
          <div className={styles.btn}>
            <a
              href="https://drive.google.com/uc?export=download&id=1KrZTW9gm5Vw2iK2SCyLwCAKCKzUNYSRC" // Resume
              target="blank"
            >
              <Button
                text={
      ...
      <div id="projects" className={styles.projects}>
        ...
        <h1 style={{ color: `${newTheme.title}` }} className={styles.heading} >Calendar</h1>
        <br /><br />
      <Calendar style={{
          background: `${newTheme.highlightBackground}`,
        }}
